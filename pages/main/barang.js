...
<div className="bg-white w-[auto] h-[auto] rounded-lg border-black p-[16px] flex flex-col gap-6">
  ...
  <Button variant="contained" color="error" className="bg-red-600" onClick={() => {setOpen(false)}}>Batal</Button> 
  <Button variant="contained" className="bg-blue-600" onClick={handleClik}>Tambah</Button> 
  </div>
  </div>
      </Modal>
      </>
...
<div className="bg-white w-[auto] h-[auto] rounded-lg border-black p-[16px] flex flex-col gap-6">
  ...
  <div className="flex items-center gap-3" style={{justifyContent:"right"}}>
  <Button variant="contained" color="error" className="bg-red-600" onClick={() => {setOpen(false)}}>Batal</Button> 
  <Button variant="contained" className="bg-blue-600" onClick={handleClik}>Lelang</Button> 
  </div>
  </div>
      </Modal>

     
        <Button className="bg-yellow-600 mb-2 flex" color="success" variant="contained" size="medium" onClick={() => {setOpen(true)}}><Edit /></Button>
        <Modal
        open={open}
        onClose={() => {setOpen(false)}}
        aria-labelledby="modal-modal-title"
...
<div className="bg-white w-[auto] h-[auto] rounded-lg border-black p-[16px] flex flex-col gap-6">
  <h1 className="text-lg font-bold">Tambahkan Ke Lelang</h1>
  <div className="flex flex-row gap-3 items-center">
  <label>Nama Barang : </label> <input type="text" name="nama_barang" value={data?.nama_barang}  className="border-black bg-gray-200 rounded-md p-[8px]"  ></input> 
  </div>
  <div className="flex flex-row gap-3 mb-2">
  <div className="gap-[61px] flex"><label>Image </label> <label>:</label></div> <div className="flex flex-col gap-3">{ !params.image ? <Image src="/assets/images/notfound.png" width={200} height={200} />: <Image src={"/upload/" + params.image} width={200} height={200} />}</div>
  </div>
  <div className="flex flex-row gap-3 items-center">
  <label>Harga Barang : </label> <input type="text" name="harga_awal" value={rupiah(data?.harga_awal)}  className="border-black bg-gray-200 rounded-md p-[8px]" ></input> 
  </div>
  <div className="flex flex-row gap-3 items-center mb-2">
  <div className="gap-10 flex"><label>Deskripsi </label> <label>:</label></div> <textarea type="text" name="deskripsi" value={data?.deskripsi}  className="border-black bg-gray-200 rounded-md p-[8px]" ></textarea> 
  </div>
  <div className="flex items-center gap-3" style={{justifyContent:"right"}}>
  <Button variant="contained" color="error" className="bg-red-600" onClick={() => {setOpen(false)}}>Batal</Button> 
  <Button variant="contained" className="bg-blue-600" onClick={handleClik}>Lelang</Button> 
...
export const Laporan = () => {
  ...
  useEffect(() => {
    ...
    return(
  <>
  <h1 className="text-xl font-bold mb-2 text-center">Laporan Lelang Indonesia</h1>
